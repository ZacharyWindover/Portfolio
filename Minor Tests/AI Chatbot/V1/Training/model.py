...
tokenized_train_dataset = [tokenize(sentence) for sentence in train_dataset['text']]
tokenized_test_dataset = [tokenize(sentence) for sentence in test_dataset['text']]
tokenized_val_dataset = [tokenize(sentence) for sentence in val_dataset['text']]
...
# Step 6: Calculate a reasonable max_length for 95% of dataset or 99% of dataset
sequence_lengths = [len(sentence) for sentence in tokenized_train_dataset]
...
# Step 8: Encode the dataset
train_encoded_dataset = [encode(sentence, train_word_to_id, max_length) for sentence in tokenized_train_dataset]
test_encoded_dataset = [encode(sentence, train_word_to_id, max_length) for sentence in tokenized_test_dataset]
val_encoded_dataset = [encode(sentence, train_word_to_id, max_length) for sentence in tokenized_val_dataset]
...
# Step 11: Create the optimizer and criterion
